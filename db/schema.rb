...
ActiveRecord::Schema[7.2].define(version: 2025_09_15_082648) do
  ...
  create_table "chat_companies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chat_id"], name: "index_chat_companies_on_chat_id"
    t.index ["company_id"], name: "index_chat_companies_on_company_id"
    t.index ["create_id"], name: "index_chat_companies_on_create_id"
    t.index ["update_id"], name: "index_chat_companies_on_update_id"
  end
  ...
  add_foreign_key "chat_companies", "chats"
  add_foreign_key "chat_companies", "companies"
  add_foreign_key "chat_companies", "users", column: "create_id"
  add_foreign_key "chat_companies", "users", column: "update_id"
