...
export default class extends Controller {
  ...
  onFileTypeChange(event) {
    ...
    console.log(`File type changed to: ${select.value}`)
  }
  ...
  async uploadFiles(files, businessCategoryId, form) {
    ...
    try {
      ...
      for (const file of files) {
        ...
        formData.append('event_file[file]', file)
        formData.append('event_file[business_category_id]', businessCategoryId)
        
        const response = await fetch(`/events/${eventId}/event_files`, {
          method: 'POST',
          body: formData,
          headers: {
